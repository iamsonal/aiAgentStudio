...
| Setup External Client App | Configures a External Client App for API access |
...
Other common patterns you can configure in the framework include function-style agents for targeted tasks, email agents for message-driven workflows, and multi-agent workflow patterns for larger processes.
